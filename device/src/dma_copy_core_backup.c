		   ...
		   struct doca_comm_channel_addr_t **peer_addr)
{
    ...
    DOCA_LOG_INFO("DMA copy was done Successfully3");
	send_status_msg(ep, peer_addr, STATUS_SUCCESS);
	DOCA_LOG_INFO("DMA copy was done Successfully4");
	...
	// sleep(10);
	printf("DMA copy was done Successfully6\n");
	...
	DOCA_LOG_INFO("DMA copy was done Successfully1");

	send_status_msg(ep, peer_addr, STATUS_SUCCESS);

	DOCA_LOG_INFO("DMA copy was done Successfully2");
